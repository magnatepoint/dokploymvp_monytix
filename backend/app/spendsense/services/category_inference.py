...
def _looks_like_personal_name(text: str) -> bool:
    ...
    business_keywords = [
        ...
        "amazon", "flipkart", "swiggy", "zomato", "wiggy",  # Known merchants (+ wiggy = Swiggy variant)
        "rummy", "rummycircle", "rummytime",  # Gaming / rummy apps
        "pan", "shop", "parlour", "parlor", "vendor", "thela",  # Pan shop and vendor keywords
        "gate", "golden",  # Golden Gate Finance, etc.
    ]
